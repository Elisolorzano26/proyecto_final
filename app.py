...
from routes.rutas_usuarios import rutas_usuario  # Importa el blueprint rutas_usuario del módulo routes.rutas_usuarios
from routes.rutas_prediccion import rutas_prediccion  # Importa el blueprint rutas_prediccion del módulo routes.rutas_prediccion
...
app.register_blueprint(rutas_usuario)  # Registra el blueprint rutas_usuario en la aplicación
app.register_blueprint(rutas_prediccion)  # Registra el blueprint rutas_prediccion en la aplicación
